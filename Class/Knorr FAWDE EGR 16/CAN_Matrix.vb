<Serializable()> Public Class CAN_Matrix
    ...
    Public Sub New()
        ...
        ParametersList.Add(New ParameterProperty("EE_ACTSTAT2_CYCTIM", "00_4C", "2B_2F", 1, "02"))
        ParametersList.Add(New ParameterProperty("EE_STATUSSRCADDR", "00_11", "66_22", 1, "82"))
