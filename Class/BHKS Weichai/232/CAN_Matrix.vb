<Serializable()> Public Class CAN_Matrix
    ...
    Public ACTSerial = "MD09440R1011"
    Public ApplicationName = "EGR"
    Public SWVersion = "5846C232.000"
    Public TCIVersion = "V2.20"
    ...
    Public Sub New()
        ...
        ParametersList.Add(New ParameterProperty("EE_POWER_ON_COMMANDS", "00_51", "F6_6E", 2))
        ParametersList.Add(New ParameterProperty("EE_CONFIG_CAN_LEARN_CMD", "00_1E", "C9_24", 1))
        ...
        ParametersList.Add(New ParameterProperty("EE_COMPUTEDSTROKE", "00_5A", "ED_9E", 2))
        ParametersList.Add(New ParameterProperty("EE_CALIBENABLED", "00_16", "E1_D4", 1))
        ParametersList.Add(New ParameterProperty("EE_ MAXSPNALLWD", "00_15", "D2_D4", 1))
        ParametersList.Add(New ParameterProperty("EE_MINSPNALLWD", "00_14", "03_D5", 1))
        ParametersList.Add(New ParameterProperty("EE_ALLWDDIFMXSPN", "00_75", "12_2C", 1))
        ParametersList.Add(New ParameterProperty("EE_ALLWDDIFMNSPN", "00_1D", "FA_24", 1))
        ...
        ParametersList.Add(New ParameterProperty("EE_ACTCOMM_CYCTIM", "00_4D", "CA_09", 1))
