<Serializable()> Public Class FeedbackResults
    ...
    Public TypeStructureCommand As Integer = 1 '0-2 feedbacks, 1-1 feedbacks
    ...
    Public StatusList As String() = {"Position control", "Learn Low", "Wiping cycle", "Self calibration", "Override", "Electrical failsafe", "Undefined"}




    Public ErrorsList As String() = {"Sensor Error", "Initialization Warning", "Position Deviation", "Command Message Warning", "System Error", "Over Temperature", "Reserved", "Power Supply Warning", "Undefined"}
    Public Function MappingStatus_Index() As Integer

        MapplingStatusIndexlist.Clear()
        MapplingStatusIndexlist.AddRange({1, 2, 4, 8, 16, 32, -1})
    ...
    Public Sub AnalyseMsg_Status1()
        ...
        Dim BinaryString As String = Me.DecimalToBinary(Convert.ToInt32(Byte8, 16), 8)
        Do Until BinaryString.Length = 8
