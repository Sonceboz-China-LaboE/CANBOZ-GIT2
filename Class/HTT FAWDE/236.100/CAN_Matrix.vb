<Serializable()> Public Class CAN_Matrix
    Public ClientName = "BHKS"
    Public OMEName = "WeiChai"
    Public ACTSerial = "5846R548"
    Public ApplicationName = "EGR"
    Public SWVersion = "5846C236.002"
    Public TCIVersion = "V3.20"
    ...
    Public Sub New()
        ...
        ParametersList.Add(New ParameterProperty("EE_POWER_ON_COMMANDS", "00_51", "56_9D", 2, "0080"))
        ParametersList.Add(New ParameterProperty("EE_CONFIG_CAN_LEARN_CMD", "00_1E", "69_D7", 1, "10"))
        ...
        ParametersList.Add(New ParameterProperty("EE_COMPUTEDSTROKE", "00_5A", "2D_9C", 2))
        ParametersList.Add(New ParameterProperty("EE_CALIBENABLED", "00_16", "21_D6", 1, "00"))
        ParametersList.Add(New ParameterProperty("EE_MAXSPNALLWD", "00_15", "12_D6", 1, "73"))
        ParametersList.Add(New ParameterProperty("EE_MINSPNALLWD", "00_14", "C3_D7", 1, "0A"))
        ParametersList.Add(New ParameterProperty("EE_ALLWDDIFMXSPN", "00_75", "B2_DF", 1, "2A"))
        ParametersList.Add(New ParameterProperty("EE_ALLWDDIFMNSPN", "00_1D", "5A_D7", 1, "2A"))
        'ParametersList.Add(New ParameterProperty("EE_CURRENTLIM4", "00_03", "44_27", 1))

        ParametersList.Add(New ParameterProperty("EE_HISTOAUTOSAVE", "00_74", "63_DE", 1, "01"))
        ParametersList.Add(New ParameterProperty("EE_LOCKBYTE", "00_35", "72_D1", 1, "00"))

        ParametersList.Add(New ParameterProperty("EE_ACTSTAT1_CYCTIM", "00_4D", "0A_DB", 1, "02"))
        ParametersList.Add(New ParameterProperty("FULLSTROKE_U16", "40_11", "52_D2", 2, "0000"))
